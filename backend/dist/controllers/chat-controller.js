...
var generateChatCompletion = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var message, user, chats, openai, chatResponse, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                ...
                if (error_1.response) {
                    console.error("API response error:", error_1.response.data);
                }
                return [2 /*return*/, res
                        .status(500)
                        .json({ message: "Internal server error", error: error_1.message })];
